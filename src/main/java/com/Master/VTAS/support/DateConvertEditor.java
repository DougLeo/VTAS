...
public class DateConvertEditor extends PropertyEditorSupport {
	 ...
	 */
	public DateConvertEditor(DateFormat dateFormat, boolean allowEmpty) {
	 ...
	 */
	public DateConvertEditor(DateFormat dateFormat, boolean allowEmpty, int exactDateLength) {
		this.dateFormat = dateFormat;
		this.allowEmpty = allowEmpty;
